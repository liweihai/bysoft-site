...
export default function EditForm({id, title, category, keywords, remark, content, categories, tags}) {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                    ...
                    <div className="relative">
                        <select id="category" name="category" value={category} className="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded pl-3 pr-8 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:shadow-md appearance-none cursor-pointer">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative">
                        <select multiple id="keywords" name="keywords" value={keywords} className="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded pl-3 pr-8 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:shadow-md appearance-none cursor-pointer">
                        {tags.map((tag) => {
                            return (
