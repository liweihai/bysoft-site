/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: 408172049aa968a21bec6e1bf10ef9c4)
// Runtime types generated with workerd@1.20250508.0 2025-04-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		API_HOST: "https://www.bysoft.net.cn";
		NEXTJS_ENV: string;
		API_CODE: string;
		AUTH_SECRET: string;
		AUTH_GITHUB_ID: string;
		AUTH_GITHUB_SECRET: string;
		WORKER_SELF_REFERENCE: Fetcher /* bysoft-site */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_HOST" | "NEXTJS_ENV" | "API_CODE" | "AUTH_SECRET" | "AUTH_GITHUB_ID" | "AUTH_GITHUB_SECRET">> {}
}
