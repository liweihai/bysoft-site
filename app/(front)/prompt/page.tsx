...
export default async function Page(props: { searchParams: Promise<{ page?: string }> }) {
    ...
    const blogs = await findModels<Prompt>("Article", {state: 1, category: '提示语'}, {select: 'id, title, keywords, remark, create_time, state, category', limit: POSTS_PER_PAGE, offset: (page - 1) * POSTS_PER_PAGE, order: 'create_time DESC'})
